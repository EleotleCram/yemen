...
const interactiveLog = require('logia')("yemen/interactive")
...
class Action {
	...
	do(resultOfPreviousAction) {
		interactiveLog.debug(` * ${this.description} (resultOfPreviousAction=${
			(resultOfPreviousAction !== undefined && !_.isObject(resultOfPreviousAction)) ? resultOfPreviousAction} : ""})`);
